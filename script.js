...
const translations = {
  en: {
    ...
    'credentials.neurips': 'Cross-paper scientific skill evaluation manuscript submitted to the NeurIPS 2026 AI4DD Workshop',
    ...
    'pub4.status': 'Submitted · NeurIPS 2026 Workshop AI4DD',
  ...
  zh: {
    ...
    'credentials.neurips': '跨论文压缩科学能力评估稿件投稿 NeurIPS 2026 AI4DD Workshop',
    ...
    'pub3.action': '查看稿件记录',
    'pub4.status': '投稿中 · NeurIPS 2026 Workshop AI4DD',
