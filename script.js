...
const translations = {
  en: {
    ...
    'profile.heading': 'A recommendation-ready profile for <em>AI for Science.</em>',
    ...
    'profile.awards.item3': 'Outstanding Communist Youth League Member Model, university-level top-ten selection.',
    'profile.awards.item4': 'Xinghuo Cup awards in LLM Agent and academic A-track competitions.',
    'profile.outputs.kicker': 'Outputs',
    'profile.outputs.title': 'Papers & manuscripts',
    'profile.outputs.item1': 'Bioinformatics paper on peptide engineering language models, published as second author / undergraduate lead author.',
    ...
    'profile.outputs.item3': 'Peptide property prediction benchmark manuscript submitted to Briefings in Bioinformatics.',
    'profile.broader.kicker': 'Broader profile',
    'profile.broader.title': 'Service, exchange & arts',
    'profile.broader.item1': 'Cambridge summer visiting program project lead, first-prize completion award.',
    'profile.broader.item2': '714 hours of volunteer service across community, education and public-service activities.',
    'profile.broader.item3': 'Violinist in Xidian University Symphony Orchestra and student committee service in class.',
    'credentials.kicker': 'Selected evidence',
    'credentials.title': 'Certificates from competitions and academic exchange.',
    'credentials.xinghuoSpecial': 'Xinghuo Cup special prize for task-adaptive molecular pretraining.',
    'credentials.xinghuoFirst': 'Xinghuo Cup first prize for an on-device AI campus application.',
  ...
  zh: {
    ...
    scroll: '查看研究',
    'profile.kicker': '学术概览',
    'profile.heading': '面向保研展示的 <em>AI for Science</em> 个人画像。',
    ...
    'profile.awards.item3': '校级优秀共青团员标兵，入选校级十佳评选。',
    'profile.awards.item4': '星火杯 LLM Agent 与学术 A 赛道相关奖项。',
    'profile.outputs.kicker': '成果',
    'profile.outputs.title': '论文与稿件',
    'profile.outputs.item1': '多肽工程语言模型论文发表于 Bioinformatics，第二作者 / 本科生一作。',
    'profile.outputs.item2': '3D-MPG 分子预训练稿件投稿 AAAI 2027，第二作者 / 本科生一作。',
    'profile.outputs.item3': '多肽性质预测系统性基准稿件投稿 Briefings in Bioinformatics。',
    'profile.broader.kicker': '综合素质',
    'profile.broader.title': '服务、交流与艺术',
    'profile.broader.item1': '剑桥暑期访学项目负责人，获得一等奖结业评价。',
    'profile.broader.item2': '累计 714 小时志愿服务，覆盖社区、教育与公共服务活动。',
    'profile.broader.item3': '西电交响乐团小提琴成员，并担任班级学习委员、心理委员等学生工作。',
    'credentials.kicker': '部分证明材料',
    'credentials.title': '竞赛获奖与国际交流证书。',
    'credentials.xinghuoSpecial': '星火杯特等奖：面向任务自适应的分子预训练平台。',
    'credentials.xinghuoFirst': '星火杯一等奖：基于端侧 AI 的校园失物智能识别与管理应用。',
