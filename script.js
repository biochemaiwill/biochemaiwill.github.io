...
const translations = {
  en: {
    ...
    'hero.cta.outputs': 'View publications',
    'hero.cta.qr': 'Scan QR',
    ...
    'spotlight.paper.note': 'Bioinformatics · Published · Second author',
    'spotlight.iclr.kicker': 'Submission',
    'spotlight.iclr.value': 'ICLR 2027',
    'spotlight.iclr.note': 'CCF A · Second author',
    'spotlight.geometry.kicker': 'Submission',
    'spotlight.geometry.value': 'AAAI 2027',
    'spotlight.geometry.note': 'CCF A · Second author',
    ...
    'profile.outputs.item2': 'NAILONG manuscript submitted to ICLR 2027, a <strong class="highlight">CCF A</strong> conference, as second author.',
    'profile.outputs.item3': '3D-MPG molecular pretraining manuscript submitted to AAAI 2027, a <strong class="highlight">CCF A</strong> conference, as second author / undergraduate lead author.',
    'profile.outputs.item4': 'The Unforkable Cache manuscript submitted to ICLR 2027, a <strong class="highlight">CCF A</strong> conference, as third author.',
    'profile.outputs.item5': 'Peptide property prediction benchmark manuscript submitted to Briefings in Bioinformatics, a <strong class="highlight">JCR Q1</strong> journal, as third author.',
    'profile.outputs.item6': 'Paper2Skill manuscript submitted to ICLR 2027, a <strong class="highlight">CCF A</strong> conference, as seventh author.',
    'profile.outputs.item7': 'Cross-paper scientific skill evaluation manuscript submitted to the NeurIPS 2026 AI4DD Workshop.',
    ...
    'credentials.neurips': 'NeurIPS 2026 AI4DD Workshop submission record for the cross-paper scientific skill evaluation manuscript',
    'credentials.iclrNailong': 'ICLR 2027 submission record for NAILONG, second author',
    'credentials.iclrUnforkable': 'ICLR 2027 submission record for The Unforkable Cache, third author',
    'credentials.iclrPaper2Skill': 'ICLR 2027 submission record for Paper2Skill, seventh author',
    ...
    'life.awardCeremony': 'Campus award ceremony',
    'life.profilePresentation': 'Campus profile presentation',
    ...
    'pub4.status': 'Submitted · NeurIPS 2026 · <strong>AI4DD Workshop</strong>',
    'pub4.desc': 'The manuscript was submitted to the NeurIPS 2026 AI4DD Workshop on 6 September 2026.',
    'pub4.action': 'View submission record',
    'pub5.status': 'Submitted · ICLR 2027 · <strong>CCF A</strong>',
    'pub5.desc': 'Second author. The manuscript was submitted to ICLR 2027 on 19 September 2026.',
    'pub5.action': 'View submission record',
    'pub6.status': 'Submitted · ICLR 2027 · <strong>CCF A</strong>',
    'pub6.desc': 'Third author. The manuscript was submitted to ICLR 2027 on 19 September 2026.',
    'pub6.action': 'View submission record',
    'pub7.status': 'Submitted · ICLR 2027 · <strong>CCF A</strong>',
  ...
  zh: {
    ...
    'hero.cta.research': '查看研究项目',
    'hero.cta.outputs': '查看论文成果',
    'hero.cta.qr': '扫码访问',
    ...
    'mobile.cta.research': '查看研究项目',
    'mobile.cta.outputs': '查看论文成果',
    ...
    'spotlight.paper.value': 'CCF A',
    'spotlight.paper.note': 'Bioinformatics · 已发表 · 第二作者',
    'spotlight.iclr.kicker': '投稿',
    'spotlight.iclr.value': 'ICLR 2027',
    'spotlight.iclr.note': 'CCF A · 第二作者',
    'spotlight.geometry.kicker': '投稿',
    'spotlight.geometry.value': 'AAAI 2027',
    'spotlight.geometry.note': 'CCF A · 第二作者',
    ...
    'profile.outputs.item2': 'NAILONG 稿件投稿 ICLR 2027（<strong class="highlight">CCF A</strong>），第二作者。',
    'profile.outputs.item3': '3D-MPG 分子预训练稿件投稿 AAAI 2027（<strong class="highlight">CCF A</strong>），第二作者 / 本科生一作。',
    'profile.outputs.item4': 'The Unforkable Cache 稿件投稿 ICLR 2027（<strong class="highlight">CCF A</strong>），第三作者。',
    'profile.outputs.item5': '多肽性质预测系统性基准稿件投稿 Briefings in Bioinformatics（<strong class="highlight">JCR Q1</strong>），第三作者。',
    'profile.outputs.item6': 'Paper2Skill 稿件投稿 ICLR 2027（<strong class="highlight">CCF A</strong>），第七作者。',
    'profile.outputs.item7': '跨论文压缩科学能力评估稿件投稿 NeurIPS 2026 AI4DD Workshop。',
    ...
    'credentials.neurips': 'NeurIPS 2026 AI4DD Workshop 投稿记录：跨论文压缩科学能力评估稿件',
    'credentials.iclrNailong': 'ICLR 2027 投稿记录：NAILONG，第二作者',
    'credentials.iclrUnforkable': 'ICLR 2027 投稿记录：The Unforkable Cache，第三作者',
    'credentials.iclrPaper2Skill': 'ICLR 2027 投稿记录：Paper2Skill，第七作者',
    ...
    'life.awardCeremony': '校园荣誉颁奖现场',
    'life.profilePresentation': '综合发展展示现场',
    ...
    'pub3.action': '查看稿件记录',
    'pub4.status': '投稿中 · NeurIPS 2026 · <strong>AI4DD Workshop</strong>',
    'pub4.desc': '稿件于 2026 年 9 月 6 日投稿 NeurIPS 2026 AI4DD Workshop。',
    'pub4.action': '查看投稿记录',
    'pub5.status': '投稿中 · ICLR 2027 · <strong>CCF A</strong>',
    'pub5.desc': '第二作者。稿件于 2026 年 9 月 19 日投稿 ICLR 2027。',
    'pub5.action': '查看投稿记录',
    'pub6.status': '投稿中 · ICLR 2027 · <strong>CCF A</strong>',
    'pub6.desc': '第三作者。稿件于 2026 年 9 月 19 日投稿 ICLR 2027。',
    'pub6.action': '查看投稿记录',
    'pub7.status': '投稿中 · ICLR 2027 · <strong>CCF A</strong>',
