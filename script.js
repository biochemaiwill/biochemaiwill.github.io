...
const translations = {
  en: {
    ...
    'spotlight.neurips.kicker': 'Workshop',
    'spotlight.neurips.value': 'NeurIPS 2026',
    'spotlight.neurips.note': 'AI4DD submission',
    ...
    'profile.outputs.item4': 'Cross-paper scientific skill evaluation manuscript submitted to the NeurIPS 2026 AI4DD Workshop.',
    'profile.outputs.item5': 'Three manuscripts submitted to ICLR 2027 as second, third and seventh author.',
  ...
  zh: {
    ...
    'spotlight.neurips.kicker': 'Workshop',
    'spotlight.neurips.value': 'NeurIPS 2026',
    'spotlight.neurips.note': 'AI4DD 投稿记录',
    ...
    'profile.outputs.item4': '跨论文压缩科学能力评估稿件投稿 NeurIPS 2026 AI4DD Workshop。',
    'profile.outputs.item5': '三篇稿件投稿 ICLR 2027，作者顺序分别为第二作者、第三作者和第七作者。',
    ...
    'pub4.action': '查看投稿记录',
    'pub5.status': '投稿中 · ICLR 2027 · <strong>第二作者</strong>',
    'pub5.desc': '第二作者。稿件于 2026 年 9 月 19 日投稿 ICLR 2027。',
    'pub5.action': '查看投稿记录',
    'pub6.status': '投稿中 · ICLR 2027 · <strong>第三作者</strong>',
    'pub6.desc': '第三作者。稿件于 2026 年 9 月 19 日投稿 ICLR 2027。',
    'pub6.action': '查看投稿记录',
    'pub7.status': '投稿中 · ICLR 2027 · <strong>第七作者</strong>',
