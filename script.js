...
const translations = {
  en: {
    ...
    'life.summary': 'Research training, academic sharing, international exchange and high-level orchestra performance',
  ...
  zh: {
    ...
    'life.summary': '科研实习、生涯规划分享、国际交流与高水平艺术团实践共同构成本科阶段的综合成长经历',
